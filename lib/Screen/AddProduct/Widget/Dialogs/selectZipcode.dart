...
selectZipcode(BuildContext context, Function setState) {
  return addProvider!.deliverabletypeValue == "2" ||
              ...
              Expanded(
                child: InkWell(
                  child: Container(
                    ...
                    child: addProvider!.deliverableZipcodes == null
                        ? Text(
                            getTranslated(context, "Select ZipCode")!,
                          )
                        : Text("${addProvider!.deliverableZipcodes}"),
                  ),
                  onTap: () {
