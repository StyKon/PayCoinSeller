...
import 'package:sellermultivendor/Screen/FAQ/widget/uploadFaQWidget.dart';
                                ...
                                if (faqProvider!
                                  ...
                                  Future.delayed(const Duration(seconds: 2))
                                    ...
                                    (_) async {
                                      faqProvider!.scrollLoadmore = true;
                                      faqProvider!.scrollOffset = 0;
                                      faqProvider!.getFaQs(context, setStateNow, id);
                                      setStateNow();
                                    },
                                  );
                                }
    ...
    return faqProvider!.scrollNodata
        ? Column(
            children: [
              ...
              // UploadFaQWidget(id: widget.id!, setStateNow: setStateNow),
              Container(
                height: height * 0.9,
